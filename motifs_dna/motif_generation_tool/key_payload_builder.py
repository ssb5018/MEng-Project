...
async def main():
    ...
    num_rounds = 1
    num_successful_keys_payloads = 0
    ...
    for i in range(num_rounds):
        ...
        # print('motifs: ', keyPayloadBuilder.get_motifs(keys, payloads))
        num_successful_keys_payloads += 1

    print('Number of motif sets conforming to the constraints is ', num_successful_keys_payloads)
